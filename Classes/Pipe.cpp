...
void Pipe::SpawnPipe(cocos2d::Layer* layer)
{
    ...
    auto pointBody = PhysicsBody::createBox(Size(1, Sprite::create("ipadhd/Ball.png")->getContentSize().height * PIPE_GAP));
    ...
    pointNode->setPosition(Point(topPipe->getPositionX(), topPipe->getPositionY() - (topPipe->getContentSize().height / 2) - ((Sprite::create("ipadhd/Ball.png")->getContentSize().height * PIPE_GAP) / 2)));
